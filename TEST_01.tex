...
\hypersetup{
  pdftitle={EXPLORATORY ANALYSIS OF IMPORTS BY COUNTRY},
  pdfauthor={Ramon Larrode - ID 0221356307},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{EXPLORATORY ANALYSIS OF IMPORTS BY COUNTRY}
...
\includegraphics{TEST_01_files/figure-latex/pressure-1.pdf}
